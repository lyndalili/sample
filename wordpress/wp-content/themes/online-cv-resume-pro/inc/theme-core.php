...
if ( ! function_exists( 'online_cv_resume_setup' ) ) :
	...
	function online_cv_resume_setup() {
		 ...
		 */
		load_theme_textdomain( 'online-cv-resume-pro', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'primary' => esc_html__( 'Primary', 'online-cv-resume-pro' ),
		) );
...
function online_cv_resume_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'online-cv-resume-pro' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'online-cv-resume-pro' ),
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Home Page hero Section', 'online-cv-resume-pro' ),
		'id'            => 'hero',
		'description'   => esc_html__( 'Add widgets here.', 'online-cv-resume-pro' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
...
function online_cv_resume_scripts() {
	...
	wp_enqueue_style( 'online-cv-resume-pro-flaticon', get_template_directory_uri() . '/vendor/flaticon/flaticon.css', array(), '1.0' );
	
	wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/vendor/bootstrap/css/bootstrap.css', array(), '4.0.0' );
	
	wp_enqueue_style( 'magnific-popup', get_template_directory_uri() . '/vendor/magnific-popup/magnific-popup.css', array(), '3.5.6' );

	wp_enqueue_style( 'owl-carousel', get_template_directory_uri() . '/vendor/owl-carousel/assets/owl.carousel.css', array(), '3.5.6' );
	wp_enqueue_style( 'owl-animate', get_template_directory_uri() . '/vendor/owl-carousel/assets/animate.css', array(), '3.5.6' );

	wp_enqueue_style( 'aos-next', get_template_directory_uri() . '/vendor/aos-next/aos.css');
	wp_enqueue_style( 'online_cv_resume-css', get_template_directory_uri() . '/assets/css/online-cv-resume-pro.css', array(), '1.0.0' );
	wp_enqueue_style( 'dashicons' );
	wp_enqueue_style( 'online_cv_resume-style', get_stylesheet_uri() );
	
	wp_enqueue_style( 'online_cv_resume-responsive', get_template_directory_uri() . '/assets/css/online-cv-resume-pro-responsive.css', array(), '1.0.0' );
	...
	wp_enqueue_script( 'magnific-popup-js', get_template_directory_uri() . '/vendor/magnific-popup/magnific-popup.js', array(), '', true  );
	...
	wp_enqueue_script( 'jquery-countTo', get_template_directory_uri() . '/vendor/jquery.countTo.js', array(), '', true );
	wp_enqueue_script( 'jquery-mixitup', get_template_directory_uri() . '/vendor/jquery.mixitup.min.js', array(), '', true );
	wp_enqueue_script( 'jquery-slimscroll', get_template_directory_uri() . '/vendor/jquery.slimscroll.js', array(), '', true );
	wp_enqueue_script( 'jquery-typed', get_template_directory_uri() . '/vendor/typer.js', array(), '', true );
	wp_enqueue_script( 'jquery-easing', get_template_directory_uri() . '/vendor/jquery.easing.js', array(), '', true );

	wp_enqueue_script( 'online_cv_resume-js', get_template_directory_uri() . '/assets/js/online-cv-resume-pro.js', array(), '', true );
...
function online_cv_resume_custom_header_setup() {
	...
	register_default_headers( array(
		...
		'description' => esc_html__( 'Default Header Image', 'online-cv-resume-pro' ),
		),
	));
}
